...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let alertBg = ColorAsset(name: "alertBg")
    internal static let black = ColorAsset(name: "black")
    internal static let buttonBg = ColorAsset(name: "buttonBg")
    internal static let loaderBg = ColorAsset(name: "loaderBg")
    internal static let sampleImg = ImageAsset(name: "sampleImg")
    internal static let textBg = ColorAsset(name: "textBg")
