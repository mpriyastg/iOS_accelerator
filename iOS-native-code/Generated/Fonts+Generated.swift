...
internal enum FontFamily {
  internal enum NotoSans {
    ...
    internal static let boldItalic = FontConvertible(name: "NotoSans-BoldItalic", family: "Noto Sans", path: "NotoSans-BoldItalic.ttf")
    internal static let italic = FontConvertible(name: "NotoSans-Italic", family: "Noto Sans", path: "NotoSans-Italic.ttf")
